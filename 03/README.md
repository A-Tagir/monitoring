...
* Создаем Alert для панели CPULa1, ставим порог 90%
...
* Видим, что показатель стал выше 90% в 18:09, а в 18:14 (через 5 минут) статус перешел в Pending

![Alert Pending](https://github.com/A-Tagir/monitoring/blob/main/03/CICD_Grafana_alert_pending.png)

* Далее еще через  5 минут состояние стало Alerting, что соответствует заданным параметрам Alert

![Alerting](https://github.com/A-Tagir/monitoring/blob/main/03/CICD_Grafana_alerting.png)

## Задание 4

* Сохраняем Dashboard в JSON
  ...
  "panels": [
    {
      ...
      "dashes": false,
      "datasource": null,
      "description": "Node CPU usage total",
      "fieldConfig": {
        "defaults": {
          "custom": {}
        },
      ...
      "targets": [
        {
          "expr": "100 - ((irate(node_cpu_seconds_total{job=\"nodeexporter\",mode=\"idle\"}[5m])) * 100)",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
    ...
    },
    {
      ...
      "dashes": false,
      "datasource": null,
      "description": "Средняя загрузка CPU за 1 минуту",
      "fieldConfig": {
        "defaults": {
          "custom": {}
        },
    ...
    },
    {
      ...
      "dashes": false,
      "datasource": null,
      "description": "Средняя загрузка CPU за 5 минут",
      "fieldConfig": {
        "defaults": {
          "custom": {}
        },
    ...
    },
    {
      ...
      "dashes": false,
      "datasource": null,
      "description": "Средняя загрузка CPU за 15 минут",
      "fieldConfig": {
        "defaults": {
          "custom": {}
        },
